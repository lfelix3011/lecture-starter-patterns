...
toDo.cards = [
  new Card('Implement renaming lists', 'Expected result - possibility to change the name of the list'),
  new Card('Implement adding cards', 'Expected result - possibility to create new cards'),
  new Card('Implement removing cards', 'Expected result - possibility to delete the card when button is clicked'),
  new Card('Implement card title renaming', 'Expected result - possibility to change the card title'),
  new Card('Implement card description renaming', 'Expected result - possibility to change the card description'),
  new Card(
...
inProgress.cards = [new Card('Implement adding lists', 'Expected result - possibility to create a new list')];
